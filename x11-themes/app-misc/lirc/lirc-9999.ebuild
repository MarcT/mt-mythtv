...
pkg_postinst() {
	...
	ewarn
	ewarn "If you updated from a previous release and your remote stoped working"
	ewarn "make sure the program you are using is pointed to /var/run/lirc/lircd"
	ewarn "If you are unable to start /etc/init.d/lircd make sure /var/run/lirc is created."
	ewarn
}
